  ...
  return (
    <div className="container mx-auto py-8 max-w-4xl">
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        <h1 className="text-3xl font-bold mb-6">Terms of Service for Examinaite</h1>
        
        <p className="mb-4">By using Examinaite, you agree to the following terms and conditions:</p>
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">Disclaimers</h2>
        <p className="mb-4">
